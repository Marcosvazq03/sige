...
class InstitutoEmpresa(models.Model):
    ...
    practicas_ids = fields.One2many("instituto2.practicas", "empresa_id", string=' Alumnos')

    # Se relaciona con la tabla valoracion
    valoraciones_ids = fields.Many2many("instituto2.valoracion", string="Valoraciones")
